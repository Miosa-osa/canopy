...
export function updateGoal(shortId: string, body: UpdateGoalBody): Promise<Goal> {
...
export function postGoalProgress(shortId: string, body: GoalProgressBody): Promise<Goal> {
...
export function updateGoalMutation() {
  return {
    ...
    mutationFn: ({ shortId, body }: { shortId: string; body: UpdateGoalBody }) =>
...
export function goalProgressMutation() {
  return {
    ...
    mutationFn: ({ shortId, body }: { shortId: string; body: GoalProgressBody }) =>
