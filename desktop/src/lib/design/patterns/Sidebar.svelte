...
const groups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Files', path: '/coming-soon', icon: FolderOpen as IconComponent, comingSoon: true },
      { label: 'Docs', path: '/coming-soon', icon: FileText as IconComponent, comingSoon: true },
      {
        label: 'Tasks',
        path: '/coming-soon',
