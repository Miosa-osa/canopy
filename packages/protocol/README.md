...
| [company-format.md](company-format.md) | `company.yaml` schema — org chart, budgets, governance for a whole company. |
| [department-format.md](department-format.md) | Department manifest format — a subdivision within a division. |
| [division-format.md](division-format.md) | Division manifest — the top organizational layer within an Operation. |
...
| [team-format.md](team-format.md) | Team manifest — organizational subtree grouping agents. |
